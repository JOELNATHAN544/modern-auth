...
import { BarChart3, TrendingUp, TrendingDown, Users, Shield, Activity } from 'lucide-react';
...
const AnalyticsPage = () => {
  ...
  const stepUpData = [
    { name: 'Triggered', value: analytics.stepUpAuth.triggered, fill: '#ffc107' },
    { name: 'Completed', value: analytics.stepUpAuth.completed, fill: '#28a745' }
  ];
  ...
  const getDeltaIcon = () => {
    const delta = parseFloat(analytics.delta.percentage);
    return delta > 0 ? <TrendingUp size={20} /> : delta < 0 ? <TrendingDown size={20} /> : null;
  };
    ...
    <div>
      <div className="card">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 style={{ fontSize: '24px', fontWeight: '600' }}>Analytics Dashboard</h1>
            <p className="text-muted">Conversion rates and authentication metrics</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-3">
        <div className="card">
          ...
          <p style={{ fontSize: '14px', color: '#888' }}>
            Password: {analytics.password.started} | Passkey: {analytics.passkey.started}
          </p>
        </div>
        ...
        <div className="card">
          ...
          <p style={{ fontSize: '14px', color: '#888' }}>
            Password: {analytics.password.completed} | Passkey: {analytics.passkey.completed}
          </p>
        </div>
        ...
        <div className="card">
          ...
          <div style={{ fontSize: '24px', fontWeight: '700', marginBottom: '4px', color: getDeltaColor() }}>
            {getDeltaIcon()}
          ...
          <div>
            <div className="space-y-4">
              <div className="card" style={{ background: '#2a2a2a' }}>
                <h4 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '12px', color: '#dc3545' }}>
                  Password Authentication
                </h4>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span>Started:</span>
                    <span style={{ fontWeight: '600' }}>{analytics.password.started}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Completed:</span>
                    <span style={{ fontWeight: '600' }}>{analytics.password.completed}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="card" style={{ background: '#2a2a2a' }}>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span>Started:</span>
                    <span style={{ fontWeight: '600' }}>{analytics.passkey.started}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Completed:</span>
                    <span style={{ fontWeight: '600' }}>{analytics.passkey.completed}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Conversion Rate:</span>
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span style={{ fontWeight: '600' }}>{analytics.totalTransactions}</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span style={{ fontWeight: '600' }}>
                {analytics.stepUpAuth.triggered > 0 
                  ? ((analytics.stepUpAuth.completed / analytics.stepUpAuth.triggered) * 100).toFixed(1) + '%'
                  : '0%'
                }
              </span>
            </div>
